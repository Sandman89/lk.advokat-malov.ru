 ...
 * @copyright Pasquale P - www.paskuale.it
...
class yii2fullcalendar extends elWidget
{
    ...
    */
    ...
    /**
     * @var array options default view
     */
    public $plugins = ['dayGrid','timeGrid','interaction'];
    ...
    */
	...
	if(!is_null($this->contentHeight) && !isset($this->clientOptions['contentHeight']))
        ...
        //$this->clientOptions['plugins'] = ['dayGrid','interaction'];
        ...
        //VarDumper::dump($cleanOptions);die();
